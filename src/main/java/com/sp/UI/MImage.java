...
public class MImage {
    ...
    public static Image enableProxyImage;
    public static Image disableProxyImage;
    public static Image RemoteDeskImage;
    public static Image captureImage;
    public static Image bsoImage;
    public static Image bsoImageGo;
    ...
    static {
        try {
            ...
            enableProxyImage = new Image(MainFrame.display, new ClassPathResource("icon/enableproxy.png").getInputStream());
            disableProxyImage = new Image(MainFrame.display, new ClassPathResource("icon/disableproxy.png").getInputStream());
            ...
            bsoImage = new Image(MainFrame.display, new ClassPathResource("icon/bso.png").getInputStream());
            bsoImageGo = new Image(MainFrame.display, new ClassPathResource("icon/bso_go.png").getInputStream());
